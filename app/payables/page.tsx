...
export default async function Payables() {
  ...
  const items = await getOpenItems(company.id, "PURCHASE_INVOICE");
  ...
  return (
    <>
      <div className="page-head">
        ...
        <h1>Payables</h1>
        <span className="page-sub">Supplier invoices awaiting payment.</span>
      </div>
        ...
        <div className="card">
          ...
          <div className="tablewrap">
            <table>
              <thead>
                <tr>
                  <th>Bill</th><th>Supplier</th><th>Posted</th><th>Due</th>
                  <th className="r">Billed</th><th className="r">Paid</th>
